    ...
    >
      ...
      <div className="relative mx-auto mb-6 max-w-4xl">
        ...
        <div
          ...
          style={{
            background: "linear-gradient(90deg, #ff6b35 0%, #d2691e 50%, #e07a5f 100%)",
          }}
        >
              ...
              >
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      backgroundColor:
                        isSelected || isHovered ? "#1a1a1a" : config.color,
                    }}
                  />
      ...
      >
        {selectedData && (
          ...
          >
            ...
            {/* Description */}
            <p className="mb-5 leading-relaxed text-cream-dark">
